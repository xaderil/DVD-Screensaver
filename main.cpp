...
int main()
{
    ...
    for (int i = 0; i < numberOfIcons; i++) {
        ...
        float y = static_cast<float>(10 + rand() % (resolutionHeight - 400));
        icons.emplace_back(DVD(texture, {x, y}, {xDirection, yDirection}));
    }
